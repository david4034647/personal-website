...
(async () => {
  ...
  for (const postId of postIds) {
    ...
    const result = await page.evaluate(() => {
      ...
      return { found: true, container: container.getAttribute('role') || container.tagName, images };
    });

    console.log(`Container: ${result.container}, Images: ${result.images?.length}`);
